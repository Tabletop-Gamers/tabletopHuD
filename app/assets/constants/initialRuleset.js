export default state = {
  ...
  skills: [
    {name: 'Climb', keyStat: 'Str', description: "Testing"},
    {name: 'Appraise', keyStat: 'Int', description: "Use this skill to tell an antique from old junk, a sword that’s old and fancy from an elven heirloom, and high-quality jewelry from cheap stuff made to look good."},
    {name: 'Balance', keyStat: 'Dex', description: ""},
    {name: 'Bluff', keyStat: 'Cha', description: ""},
    {name: 'Concentration', keyStat: 'Con', description: ""},
    {name: 'Craft', keyStat: 'Int', description: ""},
    {name: 'Decipher Script', keyStat: 'Int', description: ""},
    {name: 'Diplomacy', keyStat: 'Cha', description: ""},
    {name: 'Disable Device', keyStat: 'Int', description: ""},
    {name: 'Disguise', keyStat: 'Cha', description: ""},
    {name: 'Escape Artist', keyStat: 'Dex', description: ""},
    {name: 'Forgery', keyStat: 'Int', description: ""},
    {name: 'Gather Information', keyStat: 'Cha', description: ""},
    {name: 'Handle Animal', keyStat: 'Cha', description: ""},
    {name: 'Heal', keyStat: 'Wis', description: ""},
    {name: 'Hide', keyStat: 'Dex', description: ""},
    {name: 'Intimidate', keyStat: 'Cha', description: ""},
    {name: 'Jump', keyStat: 'Str', description: ""},
    {name: 'Knowledge', keyStat: 'Int', description: ""},
    {name: 'Listen', keyStat: 'Wis', description: ""},
    {name: 'Move Silently', keyStat: 'Dex', description: ""},
    {name: 'Open Lock', keyStat: 'Dex', description: ""},
    {name: 'Perform', keyStat: 'Cha', description: ""},
    {name: 'Profession', keyStat: 'Wis', description: ""},
    {name: 'Ride', keyStat: 'Dex', description: ""},
    {name: 'Search', keyStat: 'Int', description: ""},
    {name: 'Sense Motive', keyStat: 'Wis', description: ""},
    {name: 'Sleight of Hand', keyStat: 'Dex', description: ""},
    {name: 'Spellcraft', keyStat: 'Int', description: ""},
    {name: 'Spot', keyStat: 'Wis', description: ""},
    {name: 'Swim', keyStat: 'Str', description: ""},
    {name: 'Tumble', keyStat: 'Dex', description: ""},
    {name: 'Use Magic Device', keyStat: 'Cha', description: ""},
    {name: 'Use Rope', keyStat: 'Dex', description: ""},
    ]
}